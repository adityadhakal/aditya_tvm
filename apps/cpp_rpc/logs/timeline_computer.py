...
file1 = open("1_instance_timeline.txt",'r')
...
for i,times in enumerate(timeline_seconds):
    if i == 0:
        temp_prev = times
        continue
    if (times-temp_prev)>15 or (times-temp_prev)<-15:
...
print("Total Time (sec) : ",(timeline_seconds[-1]-timeline_seconds[0])+86400) #time wrap around across the day
print("Total Idle time (sec): ", total_idle+86400)
